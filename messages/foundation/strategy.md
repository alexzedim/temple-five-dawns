...
Пора смириться с тем, если вы не можете привлечь новую аудиторию в игровое сообщества, что по-сути чаще всего означает появление в ней новых игроков, из-за политики подписки...

Нам необходимо эффективно отбирать существующую аудиторию из других сообществ-векторов.
Эффективных способов известных мне, как сделать это, — немного.

Мы не можем позволить себе ту стратегию развитию, на которую основываются персонализированные сообщества.
Потому что у нас она уже себя изжила, и эффективно работает у них, а не у нас.
...
Поэтому необходимо:
 ...
 - Создавать резонансные инфо-поводы для обсуждения, которые бросают вызов привычной социальной парадигме в игровом сообществе.
...
А всех 'типа обиженных', действительно надо слать нахуй.
Но не анонимно или персонально в личках, а общественным консенсусом, предварительно и опционально, поработав и подготовив соответствующее общественное мнение.
Тем самым, донести до сообщества ту информацию, что знаем мы, симметрично.
...
Не надо слепо копировать, те стратегии которые работают у других, без понимания.
(ссылка на правила)
...
И быть готовыми к тому, что тем же самым могут ткнуть и вас. А для этого надо каждому 'повзрослеть', проработать и поработать со своими скелетами-в-шкафу, которые вызывают у вас резкие эмоции.
...
Много кто хотел править Римом или спать им, но мало кто забывает, что сердце Рима билось не среди мрамора Сената, а на песке Колизей. И Колизей, место для зрелищ, не для войн-скандалов-интриг-расследований.
