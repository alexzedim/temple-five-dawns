...
Не заводите «дружбочки» и тем самым не создавайте публичные прецеденты для «особого отношения». Желающих «навязаться», «подольститься» и «присосаться» будет предостаточно, уж поверьте.
...
Возможность более желанна, чем более она упущена.
И умение корректно продемонстрировать силу и намеренья ценятся больше, чем активное вмешательство.
